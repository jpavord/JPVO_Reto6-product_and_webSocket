...
const contenedor = require('./src/chat.js')
const c = new contenedor('chat-file.txt');
...
//     {author: "Pepe@correo.com", text: "¡Muy bien! ¿Y tu?"},
//     {author: "Pamela@correo.com", text: "¡Genial!"}
// ]

const messages = c.getAll()
